...
arq = open("arquivos/arquivo_1.txt", "x")

# abrir arquivo para escrever -> w = write
arq = open("arquivos/arquivo_1.txt", "w") 
...
if os.path.exists("arquivos/demofile.txt"):
    os.remove("arquivos/demofile.txt")
else:
